...
class ArmEnv(object):
    ...
    def step(self, action):
        ...
        a2xy =a1xy_ 
        a2xy_= np.array([np.cos(a2r), np.sin(a2r)]) * a2l + a2xy 
    ...
    def __init__(self, arm_info, goal):
        ...
        self.arm2 = self.batch.add(
            ...
            ('v2f', [100, 150,              # location
                     100, 160,
                     200, 160,
                     200, 150]), ('c3B', (50, 20, 86) * 4,))
        self.arm3=self.batch.add(
            4, pyglet.gl.GL_QUADS, None,
            ('v2f', [50, 50,              # location
                     50, 100,
                     60, 100,
                     60, 50]), ('c3B', (100, 26, 86) * 4,))
...
#        (a1r, a2r) = self.arm_info['r']     # radian, angle
        ...
        a1tr, a2tr,a3tr = np.pi / 2 - self.arm_info['r'][0], np.pi / 2 - self.arm_info['r'][1],np.pi / 2 - self.arm_info['r'][2]
        ...
        xy31 = a2xy_ + np.array([np.cos(a3tr), -np.sin(a3tr)]) * self.bar_thc
        xy32 = a2xy_ + np.array([-np.cos(a3tr), np.sin(a3tr)]) * self.bar_thc
        xy33 = finger + np.array([-np.cos(a3tr), np.sin(a3tr)]) * self.bar_thc
        xy34 = finger + np.array([np.cos(a3tr), -np.sin(a3tr)]) * self.bar_thc
